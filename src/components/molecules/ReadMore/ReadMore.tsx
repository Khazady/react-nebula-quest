  ...
  return (
    <>
      ...
      <label htmlFor={id} className={cn("readmore__button", buttonClassName)}>
        <span className="readmore__button-label readmore__button-label--off">{moreLabel}</span>
        <span className="readmore__button-label readmore__button-label--on">{lessLabel}</span>
      </label>
    </>
  );
};
